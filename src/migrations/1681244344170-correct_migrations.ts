...
export class CorrectMigrations1681244344170 implements MigrationInterface {
    name = 'CorrectMigrations1681244344170'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announce" ("id" SERIAL NOT NULL, "year" integer NOT NULL, "km" integer NOT NULL, "price_fipe" integer NOT NULL, "price" integer NOT NULL, "description" character varying NOT NULL, "image" character varying NOT NULL, "withinFipe" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "publishedAt" boolean NOT NULL DEFAULT true, "ownerId" uuid, "markId" integer, "modelId" integer, "fuelId" integer, "colorId" integer, "galleryId" integer, CONSTRAINT "REL_ca9289562d84b0ba1ce83dd87a" UNIQUE ("galleryId"), CONSTRAINT "PK_02a142330ce2fa63d84bd13bee4" PRIMARY KEY ("id"))`);
